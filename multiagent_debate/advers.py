...
if __name__ == "__main__":
    ...
    argparser.add_argument("--dataset", type=str, default='medmcqa', choices=['mmlu', 'chess', 'math', 'mquake', 'musique', 'truthfulqa', 'medmcqa'])
    argparser.add_argument("--input_file", type=str, default='results/medmcqa/100_3_3_gpt-3.5-turbo/medmcqa_100_3_3_0.jsonl', required=False)
